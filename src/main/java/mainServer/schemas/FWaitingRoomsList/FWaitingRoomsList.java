...
public final class FWaitingRoomsList extends Table {
  ...
  public mainServer.schemas.FWaitingRoomsList.FWaitingRoom waitingRoom(int j) { return waitingRoom(new mainServer.schemas.FWaitingRoomsList.FWaitingRoom(), j); }
  public mainServer.schemas.FWaitingRoomsList.FWaitingRoom waitingRoom(mainServer.schemas.FWaitingRoomsList.FWaitingRoom obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int waitingRoomLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public mainServer.schemas.FWaitingRoomsList.FWaitingRoom.Vector waitingRoomVector() { return waitingRoomVector(new mainServer.schemas.FWaitingRoomsList.FWaitingRoom.Vector()); }
  public mainServer.schemas.FWaitingRoomsList.FWaitingRoom.Vector waitingRoomVector(mainServer.schemas.FWaitingRoomsList.FWaitingRoom.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
