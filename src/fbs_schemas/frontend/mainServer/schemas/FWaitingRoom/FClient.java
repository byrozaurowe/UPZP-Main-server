...
public final class FClient extends Table {
  ...
  public mainServer.schemas.FWaitingRoom.FVehicle vehicle() { return vehicle(new mainServer.schemas.FWaitingRoom.FVehicle()); }
  public mainServer.schemas.FWaitingRoom.FVehicle vehicle(mainServer.schemas.FWaitingRoom.FVehicle obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
