...
public final class FWaitingRoom extends Table {
  ...
  public mainServer.schemas.FWaitingRoom.FTeam teams(int j) { return teams(new mainServer.schemas.FWaitingRoom.FTeam(), j); }
  public mainServer.schemas.FWaitingRoom.FTeam teams(mainServer.schemas.FWaitingRoom.FTeam obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int teamsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public mainServer.schemas.FWaitingRoom.FTeam.Vector teamsVector() { return teamsVector(new mainServer.schemas.FWaitingRoom.FTeam.Vector()); }
  public mainServer.schemas.FWaitingRoom.FTeam.Vector teamsVector(mainServer.schemas.FWaitingRoom.FTeam.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
